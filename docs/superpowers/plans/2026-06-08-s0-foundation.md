...
> **2026-06-11 更新(ADR-014)**:出口①(数据 Spike 1/2)因外部前置(云环境/100GB 数据集)未就绪,
> 按 `docs/adr/ADR-014-s0-exit1-carryover-to-s1.md` **移交 S1 第一周入口门禁**(第 3 工作日硬时限);
> S0 以 "closed with carry-over" 关闭,签认 ADR-014 = go/no-go 签字。证据底稿:`2026-06-10-s0-dod-status.md`。
